...
public class _FileResponse_DslJsonConverter implements com.dslplatform.json.Configuration {
	...
	public void configure(com.dslplatform.json.DslJson __dsljson) {
		...
		__dsljson.registerBinder(com.springjunit.demo.model.response.FileResponse.class, objectConverter);
		__dsljson.registerReader(com.springjunit.demo.model.response.FileResponse.class, objectConverter);
		__dsljson.registerWriter(com.springjunit.demo.model.response.FileResponse.class, objectConverter);
	}
	public final static class ObjectFormatConverter implements com.dslplatform.json.runtime.FormatConverter<com.springjunit.demo.model.response.FileResponse>, com.dslplatform.json.JsonReader.BindObject<com.springjunit.demo.model.response.FileResponse> {
		...
		public com.springjunit.demo.model.response.FileResponse read(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			if (reader.wasNull()) return null;
			return bind(reader, new com.springjunit.demo.model.response.FileResponse());
		}
		...
		public final void write(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.model.response.FileResponse instance) {
		...
		public void writeContentFull(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.model.response.FileResponse instance) {
		...
		public boolean writeContentMinimal(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.model.response.FileResponse instance) {
		...
		public com.springjunit.demo.model.response.FileResponse bind(final com.dslplatform.json.JsonReader reader, final com.springjunit.demo.model.response.FileResponse instance) throws java.io.IOException {
			if (reader.last() != '{') throw reader.newParseError("Expecting '{' for object start");
			reader.getNextToken();
			bindContent(reader, instance);
			return instance;
		}
		public com.springjunit.demo.model.response.FileResponse readContent(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			com.springjunit.demo.model.response.FileResponse instance = new com.springjunit.demo.model.response.FileResponse();
 			bindContent(reader, instance);
			return instance;
		}
		public void bindContent(final com.dslplatform.json.JsonReader reader, final com.springjunit.demo.model.response.FileResponse instance) throws java.io.IOException {
		...
		private void bindSlow(final com.dslplatform.json.JsonReader reader, final com.springjunit.demo.model.response.FileResponse instance, int index) throws java.io.IOException {
