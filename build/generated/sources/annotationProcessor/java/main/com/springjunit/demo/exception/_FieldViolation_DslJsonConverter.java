package com.springjunit.demo.exception;
...
public class _FieldViolation_DslJsonConverter implements com.dslplatform.json.Configuration {
	...
	public void configure(com.dslplatform.json.DslJson __dsljson) {
		...
		__dsljson.registerReader(com.springjunit.demo.exception.FieldViolation.class, objectConverter);
		__dsljson.registerWriter(com.springjunit.demo.exception.FieldViolation.class, objectConverter);
	}
	public final static class ObjectFormatConverter implements com.dslplatform.json.runtime.FormatConverter<com.springjunit.demo.exception.FieldViolation> {
		...
		public final void write(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.exception.FieldViolation instance) {
		...
		public void writeContentFull(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.exception.FieldViolation instance) {
		...
		public boolean writeContentMinimal(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.exception.FieldViolation instance) {
		...
		public com.springjunit.demo.exception.FieldViolation read(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			if (reader.wasNull()) return null;
			else if (reader.last() != '{') throw reader.newParseError("Expecting '{' for object start");
			reader.getNextToken();
			return readContent(reader);
		}
		public com.springjunit.demo.exception.FieldViolation readContent(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			java.lang.String _field_ = null;
			java.lang.String _description_ = null;
			if (reader.last() == '}') {
				return new com.springjunit.demo.exception.FieldViolation(_field_, _description_);
			}
