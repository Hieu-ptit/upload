...
public class _Response_DslJsonConverter implements com.dslplatform.json.Configuration {
	...
	private final static class ConverterFactory implements com.dslplatform.json.DslJson.ConverterFactory<ObjectFormatConverter> {
		...
		public ObjectFormatConverter tryCreate(java.lang.reflect.Type manifest, com.dslplatform.json.DslJson __dsljson) {
			if (manifest instanceof java.lang.reflect.ParameterizedType) {
				...
				if (rawClass.isAssignableFrom(com.springjunit.demo.model.response.Response.class)) {
					return new ObjectFormatConverter(__dsljson, pt.getActualTypeArguments());
				}
			} else if (com.springjunit.demo.model.response.Response.class.equals(manifest)) {
	...
	public final static class ObjectFormatConverter<T extends java.lang.Object> implements com.dslplatform.json.runtime.FormatConverter<com.springjunit.demo.model.response.Response<T>> {
		...
		private com.dslplatform.json.JsonReader.ReadObject<com.springjunit.demo.model.response.Response.Metadata> reader_meta;
		private com.dslplatform.json.JsonReader.ReadObject<com.springjunit.demo.model.response.Response.Metadata> reader_meta() {
			if (reader_meta == null) {
				java.lang.reflect.Type manifest = com.springjunit.demo.model.response.Response.Metadata.class;
		...
		private com.dslplatform.json.JsonWriter.WriteObject<com.springjunit.demo.model.response.Response.Metadata> writer_meta;
		private com.dslplatform.json.JsonWriter.WriteObject<com.springjunit.demo.model.response.Response.Metadata> writer_meta() {
			if (writer_meta == null) {
				java.lang.reflect.Type manifest = com.springjunit.demo.model.response.Response.Metadata.class;
		...
		public final void write(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.model.response.Response<T> instance) {
		...
		public void writeContentFull(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.model.response.Response<T> instance) {
		...
		public boolean writeContentMinimal(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.model.response.Response<T> instance) {
		...
		public com.springjunit.demo.model.response.Response<T> read(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			if (reader.wasNull()) return null;
			else if (reader.last() != '{') throw reader.newParseError("Expecting '{' for object start");
			reader.getNextToken();
			return readContent(reader);
		}
		public com.springjunit.demo.model.response.Response<T> readContent(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			T _data_ = null;
			com.springjunit.demo.model.response.Response.Metadata _meta_ = null;
			if (reader.last() == '}') {
				return new com.springjunit.demo.model.response.Response<T>(_data_, _meta_);
			}
