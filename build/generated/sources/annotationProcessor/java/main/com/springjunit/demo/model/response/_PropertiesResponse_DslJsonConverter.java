...
public class _PropertiesResponse_DslJsonConverter implements com.dslplatform.json.Configuration {
	...
	public void configure(com.dslplatform.json.DslJson __dsljson) {
		...
		__dsljson.registerBinder(com.springjunit.demo.model.response.PropertiesResponse.class, objectConverter);
		__dsljson.registerReader(com.springjunit.demo.model.response.PropertiesResponse.class, objectConverter);
		__dsljson.registerWriter(com.springjunit.demo.model.response.PropertiesResponse.class, objectConverter);
	}
	public final static class ObjectFormatConverter implements com.dslplatform.json.runtime.FormatConverter<com.springjunit.demo.model.response.PropertiesResponse>, com.dslplatform.json.JsonReader.BindObject<com.springjunit.demo.model.response.PropertiesResponse> {
		...
		public com.springjunit.demo.model.response.PropertiesResponse read(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			if (reader.wasNull()) return null;
			return bind(reader, new com.springjunit.demo.model.response.PropertiesResponse());
		}
		...
		public final void write(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.model.response.PropertiesResponse instance) {
		...
		public void writeContentFull(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.model.response.PropertiesResponse instance) {
		...
		public boolean writeContentMinimal(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.model.response.PropertiesResponse instance) {
		...
		public com.springjunit.demo.model.response.PropertiesResponse bind(final com.dslplatform.json.JsonReader reader, final com.springjunit.demo.model.response.PropertiesResponse instance) throws java.io.IOException {
			if (reader.last() != '{') throw reader.newParseError("Expecting '{' for object start");
			reader.getNextToken();
			bindContent(reader, instance);
			return instance;
		}
		public com.springjunit.demo.model.response.PropertiesResponse readContent(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			com.springjunit.demo.model.response.PropertiesResponse instance = new com.springjunit.demo.model.response.PropertiesResponse();
 			bindContent(reader, instance);
			return instance;
		}
		public void bindContent(final com.dslplatform.json.JsonReader reader, final com.springjunit.demo.model.response.PropertiesResponse instance) throws java.io.IOException {
		...
		private void bindSlow(final com.dslplatform.json.JsonReader reader, final com.springjunit.demo.model.response.PropertiesResponse instance, int index) throws java.io.IOException {
