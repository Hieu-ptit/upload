...
public class _Response$Metadata_DslJsonConverter implements com.dslplatform.json.Configuration {
	...
	public void configure(com.dslplatform.json.DslJson __dsljson) {
		...
		__dsljson.registerReader(com.springjunit.demo.model.response.Response.Metadata.class, objectConverter);
		__dsljson.registerWriter(com.springjunit.demo.model.response.Response.Metadata.class, objectConverter);
	}
	public final static class ObjectFormatConverter implements com.dslplatform.json.runtime.FormatConverter<com.springjunit.demo.model.response.Response.Metadata> {
		private final boolean alwaysSerialize;
		private final com.dslplatform.json.DslJson __dsljson;
		private com.dslplatform.json.JsonReader.ReadObject<com.springjunit.demo.exception.FieldViolation> reader_errors;
		private com.dslplatform.json.JsonReader.ReadObject<com.springjunit.demo.exception.FieldViolation> reader_errors() {
			if (reader_errors == null) {
				java.lang.reflect.Type manifest = com.springjunit.demo.exception.FieldViolation.class;
		...
		private com.dslplatform.json.JsonWriter.WriteObject<com.springjunit.demo.exception.FieldViolation> writer_errors;
		private com.dslplatform.json.JsonWriter.WriteObject<com.springjunit.demo.exception.FieldViolation> writer_errors() {
		...
		public final void write(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.model.response.Response.Metadata instance) {
		...
		public void writeContentFull(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.model.response.Response.Metadata instance) {
		...
		public boolean writeContentMinimal(final com.dslplatform.json.JsonWriter writer, final com.springjunit.demo.model.response.Response.Metadata instance) {
		...
		public com.springjunit.demo.model.response.Response.Metadata read(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			if (reader.wasNull()) return null;
			else if (reader.last() != '{') throw reader.newParseError("Expecting '{' for object start");
			reader.getNextToken();
			return readContent(reader);
		}
		public com.springjunit.demo.model.response.Response.Metadata readContent(final com.dslplatform.json.JsonReader reader) throws java.io.IOException {
			...
			java.util.List<com.springjunit.demo.exception.FieldViolation> _errors_ = null;
			if (reader.last() == '}') {
				return new com.springjunit.demo.model.response.Response.Metadata(_code_, _page_, _size_, _total_, _message_, _errors_);
			}
